...
async function bootstrap() {
    ...
    await whatsappService.sendBookingConfirmation('919717440062', 'Shobhit Verma', {
    ...
    await whatsappService.sendInquiryAcknowledgement('919717440062', 'Shobhit Verma', {
        tourName: 'Vaishno Devi Yatra',
    });

    // Test 4: payment_failure
    console.log('4️⃣  Testing payment_failure template...');
    await whatsappService.sendPaymentFailure('919717440062', 'Shobhit Verma', {
        bookingReference: 'VT-2026-TEST-001',
        tourName: 'Char Dham Yatra 2026',
        totalAmount: 45000,
    });

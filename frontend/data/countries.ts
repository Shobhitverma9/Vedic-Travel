...
export const countries: CountryCode[] = [
    ...
    { name: "Central African Republic", code: "CF", flag: "🇨🇫", dial_code: "+236" },
    ...
    { name: "Congo (Congo-Brazzaville)", code: "CG", flag: "🇨🇬", dial_code: "+242" },
    ...
    { name: "Eswatini", code: "SZ", flag: "🇸🇿", dial_code: "+268" },
    ...
    { name: "Myanmar (formerly Burma)", code: "MM", flag: "🇲🇲", dial_code: "+95" },
    ...
    { name: "Saint Kitts and Nevis", code: "KN", flag: "🇰🇳", dial_code: "+1-869" },
    { name: "Saint Lucia", code: "LC", flag: "🇱🇨", dial_code: "+1-758" },
    { name: "Saint Vincent and the Grenadines", code: "VC", flag: "🇻🇨", dial_code: "+1-784" },

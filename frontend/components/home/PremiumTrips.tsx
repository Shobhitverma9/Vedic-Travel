                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="lg:w-1/2 text-center lg:text-center">
                        ...
                        <div className="flex justify-center gap-12 text-saffron">
                            {/* Phone */}
                            <Link href="tel:+919999999999" className="hover:text-deepBlue transition-colors">
                                <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                </svg>
                            </Link>
                            {/* Whatsapp */}
                            <Link href="https://wa.me/919999999999" className="hover:text-deepBlue transition-colors">
                                <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM7 9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z" clipRule="evenodd" />
                                </svg>
                            </Link>
                            {/* Email */}
                            <Link href="mailto:info@vedictravel.com" className="hover:text-deepBlue transition-colors">
                                <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 20 20">

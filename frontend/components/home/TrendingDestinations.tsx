                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                    ...
                    <div className="md:col-span-9 min-w-0">
                        <div className="relative group">
                            ...
                            <div className="md:hidden absolute inset-y-0 left-0 flex items-center z-20 pointer-events-none">
                                <button
                                    onClick={() => scroll('left')}
                            ...
                            <div className="md:hidden absolute inset-y-0 right-0 flex items-center z-20 pointer-events-none">
                                <button
                                    onClick={() => scroll('right')}

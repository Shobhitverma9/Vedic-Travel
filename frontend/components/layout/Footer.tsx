...
import { ChevronUp, ChevronRight, CreditCard, Landmark, Wallet, Globe } from 'lucide-react';
        ...
        <footer className="relative bg-[#0d1522] text-white pt-12 overflow-hidden border-t-2 border-saffron">
            ...
            <div className="container mx-auto px-6 lg:px-12 relative z-10">
                ...
                <div className="mb-6 border-t border-white/10 pt-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6 px-4 py-3 bg-white/[0.02] border border-white/5 rounded-2xl backdrop-blur-sm">
                        <div className="flex items-center gap-2">
                            <span className="text-xs font-semibold text-gray-300 uppercase tracking-widest">Payment Partners</span>
                            <div className="hidden md:block w-8 h-px bg-saffron/50"></div>
                        </div>

                        <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8">
                            <div className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors cursor-default" title="Credit & Debit Cards">
                                <CreditCard size={18} className="text-saffron" />
                                <span className="text-xs font-medium tracking-wide">All Cards</span>
                            </div>
                            <div className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors cursor-default" title="Net Banking">
                                <Landmark size={18} className="text-saffron" />
                                <span className="text-xs font-medium tracking-wide">Net Banking</span>
                            </div>
                            <div className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors cursor-default" title="EMI & Wallets">
                                <Wallet size={18} className="text-saffron" />
                                <span className="text-xs font-medium tracking-wide">Wallets & EMI</span>
                            </div>
                            <div className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors cursor-default" title="Global Pay">
                                <Globe size={18} className="text-saffron" />
                                <span className="text-xs font-medium tracking-wide">Global Pay</span>
                            </div>
                        </div>
                    </div>
                </div>

    ...
    <div className="space-y-4">
      ...
      <div className="space-y-4">
        {rooms.map((room, index) => (
          <div
            key={room.id}
            className="p-4 border border-gray-200 rounded-lg relative bg-white/50 hover:bg-white transition-colors group"
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex items-center justify-center border rounded-md bg-white">
                  ...
                  <span className="px-2 font-bold w-6 text-center text-sm">
                    {room.adults}
                  </span>
                  <button
                    onClick={() => updateRoom(index, "adults", room.adults + 1)}
              ...
              <div className="flex flex-col items-center">
                <div className="min-h-[40px] flex flex-col items-center justify-end mb-2">
                  <label className="text-xs text-gray-500 font-medium text-center">
                    Child
                  </label>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex items-center justify-center border rounded-md bg-white">
                  <button
                    onClick={() =>
                      updateRoom(index, "infants", room.infants - 1)
                    }
                    className="px-3 py-1 text-gray-500 hover:bg-gray-100 disabled:opacity-30 transition-colors"

...
const CalculatePriceContainer: React.FC<CalculatePriceContainerProps> = ({
  tour,
}) => {
  ...
  const [activePolicy, setActivePolicy] = useState<
    "payment" | "cancellation" | "terms" | "privacy" | null
  >(null);
  const [paymentOption, setPaymentOption] = useState<"partial" | "full">(
    "full",
  );
  ...
  const totalTravelers = rooms.reduce(
    (acc, room) => acc + room.adults + room.childrenWithBed,
    0,
  );
  ...
  const handleContinueClick = (e: React.MouseEvent) => {
    ...
    if (!token) {
      ...
      const corporateParams = gstEnabled
        ? `&gstEnabled=true&gstNumber=${gstNumber}&companyName=${encodeURIComponent(companyName)}`
        : "";
  ...
  // Selected payment amount - only two options: 50% partial or full
  const partialAmount = Math.round(totalCost * 0.5);
  const amountToPay = paymentOption === "partial" ? partialAmount : totalCost;
  ...
  const parseSections = (text: string | undefined, defaultTitle: string) => {
    ...
    return sections.length > 0
      ? sections
      : [{ title: defaultTitle, content: [text] }];
  };

  const togglePolicy = (
    policy: "payment" | "cancellation" | "terms" | "privacy",
  ) => {
  ...
  const renderPolicyContent = () => {
    ...
    switch (activePolicy) {
      ...
      case "terms":
        let termsText =
          tour.termsAndConditions || "Terms & Conditions coming soon...";
      ...
      return (
        <div className="p-4 bg-white border-t text-center">
          <p className="text-sm text-gray-600 mb-2">
            Our detailed privacy policy is available on a separate page.
          </p>
          <Link
            href="/privacy-policy"
            className="text-deepBlue font-bold hover:underline"
          >
            View Privacy Policy
          </Link>
        </div>
  ...
  return (
    <div
      id="calculate-price-section"
      className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-8 scroll-mt-24"
    >
      <div className="bg-gradient-to-r from-blue-50 to-white px-6 py-4 border-b border-blue-100">
        ...
        <p className="text-sm text-gray-500">
          Select your preferences to get the best price.
        </p>
      </div>
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <RoomConfiguration rooms={rooms} onChange={setRooms} />
          </div>
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              >
                <span
                  className={
                    travelDate ? "font-medium text-deepBlue" : "text-gray-400"
                  }
                >
                  {travelDate
            ...
            <div className="pt-2">
              ...
              <div className="mb-4 p-3 bg-blue-50/50 rounded-lg border border-blue-100">
                <label className="flex items-center gap-2 cursor-pointer select-none mb-3">
                  ...
                  />
                  <span className="text-sm text-deepBlue font-bold">
                    I have a GST number{" "}
                ...
                <div className="mb-4 p-3 bg-saffron/5 rounded-lg border border-saffron/20">
                  <label className="flex items-start gap-2 cursor-pointer group">
                    <input
                      ...
                      onChange={(e) =>
                        setRequestGroupDiscount(e.target.checked)
                      }
                    />
                    <div className="flex flex-col">
                      ...
                      <span className="text-[11px] text-gray-500 leading-tight">
                        Applicable for more than 6 persons. Our team will
                        contact you with special pricing.
                      </span>
                    </div>
                  </label>
                </div>
              ...
              <label className="flex items-start gap-2 cursor-pointer">
                ...
                <span className="text-sm text-gray-600">
                  ...
                  <a
                    href="#"
                    className="text-deepBlue font-medium hover:underline"
                  >
                    Privacy Policy
                  </a>
                  ,{" "}
          ...
          <div className="animate-in slide-in-from-top-4 fade-in duration-500 border-t border-dashed border-gray-300 pt-8 mt-4">
            <div className="bg-blue-50/50 rounded-xl p-6 border border-blue-100 flex flex-col md:flex-row items-center justify-between gap-6 relative">
              <div className="text-center md:text-left">
                <h3 className="text-2xl font-display text-gray-600 mb-1">
                  Total Price
                </h3>
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                ...
                <label className="cursor-pointer group relative">
                  ...
                  />
                  <div
                    className={`p-5 rounded-xl border-2 transition-all h-full text-center ${
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-500 mb-2">
                      Partial payment to confirm booking
                    </p>
                    <p className="text-2xl font-bold text-deepBlue whitespace-nowrap">
